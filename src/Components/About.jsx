...
const About = ()=>{
    return(
        <div className="p-10 ">
            <h1 className="text-4xl font-bold text-darkText text-center mb-4">
                Get to know synerg<span className="text-red-800">z</span>
            </h1>
            <hr className="border-black mb-4"/>
            <p className="text-xl text-darkText leading-relaxed">
            ...
            <p className="text-xl text-darkText leading-relaxed mt-4">
